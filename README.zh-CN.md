...
| [文档](docs/zh/) · [快速开始](docs/zh/00-getting-started.md) · [mcpp.toml 指南](docs/zh/02-mcpp-toml.md) · [示例项目](docs/zh/01-examples.md) · [工具链管理](docs/zh/20-toolchains.md) |
|:---:|
...
> 更多依赖配置方式（版本约束、命名空间、Git 引用、本地路径等）参见 [mcpp.toml 指南 — 依赖管理](docs/zh/02-mcpp-toml.md)。
...
- [mcpp.toml 指南](docs/zh/02-mcpp-toml.md)
- [工作空间](docs/zh/03-workspace.md)
