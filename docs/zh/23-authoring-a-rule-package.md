...
相关文档:[07 —— build.mcpp](07-build-mcpp.md) 是本章所用指令协议与类型化 API 的
参考;[22 —— Feature 与能力](22-features-and-capabilities.md) 覆盖 feature 相关键;
[20 —— 异构硬件构建](20-heterogeneous-builds.md) 列出已发布的规则。两个示例:
...
[05 —— mcpp.toml](05-mcpp-toml.md) 的*一个包,一个版本*。
