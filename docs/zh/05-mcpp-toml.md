...
已移入 [22 —— Feature 与能力](22-features-and-capabilities.md),
...
已移入 [17 —— 项目环境](17-the-project-environment.md)。

### 2.14 依赖产出的 host 工具

已移入 [07 —— build.mcpp](07-build-mcpp.md)。
...
已移入 [21 —— 按场景选命令](21-commands-by-scenario.md)。
