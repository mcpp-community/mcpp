...
> [workspace](03-workspace.md) member or use `[features]`, or for a whole-build mode use a
...
| Two products that differ in code they **share** | split into [workspace](03-workspace.md) members, each with its own `[build]` flags over a shared `lib` |
...
> Metal, listed in full in [32 — Heterogeneous Builds](32-heterogeneous-builds.md) — are never
...
[05-build-mcpp.md](05-build-mcpp.md) for why that asymmetry is deliberate.
...
Moved to [04 — Features and Capabilities](04-features-and-capabilities.md),
...
Moved to [05 — build.mcpp](05-build-mcpp.md).
...
See [05 — build.mcpp](05-build-mcpp.md). Naming such a file in
...
Moved to [06 — Commands by Scenario](06-commands-by-scenario.md).
