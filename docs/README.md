...
| write a library others import | [10](10-publishing-a-library.md), [05](05-mcpp-toml.md) §2.4 | [`04-workspace`](../examples/04-workspace/), [`03-features`](../examples/03-features/) |
| publish it | [02](02-pack-and-release.md), [10](10-publishing-a-library.md), [12](12-binary-distribution.md) | [`05-lib-distribution`](../examples/05-lib-distribution/), [`07-to-the-index`](../examples/07-to-the-index/) |
...
| use a GPU or an accelerator | [20](20-heterogeneous-builds.md), [18](18-devices.md) | [`09-heterogeneous`](../examples/09-heterogeneous/), starting at `boundary/` |
...
| add a package to the index | [10](10-publishing-a-library.md), [SPEC-001](specs/package-identity.md) | [`07-to-the-index`](../examples/07-to-the-index/) |
