...
Related documents: [07 — build.mcpp](07-build-mcpp.md) is the reference for the
directive protocol and the typed API this chapter uses; [22 — Features and
Capabilities](22-features-and-capabilities.md) covers the feature keys;
[20 — Heterogeneous Builds](20-heterogeneous-builds.md) is where the shipped
