...
Moved to [03 — Toolchain Management](03-toolchains.md).
...
Moved to [14 — The Target Side](14-target-side.md).
...
Moved to [22 — Features and Capabilities](22-features-and-capabilities.md),
...
Moved to [17 — The Project Environment](17-the-project-environment.md).

### 2.14 Host tools from a dependency

Moved to [07 — build.mcpp](07-build-mcpp.md).
...
Moved to [21 — Commands by Scenario](21-commands-by-scenario.md).
